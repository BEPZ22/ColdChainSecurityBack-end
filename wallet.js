...
function readCertCryptogen(org, user) {
    ...
    var certPath = CRYPTO_CONFIG_PEER_ORGS + "/users/" + user + "@" + org + ".com/msp/signcerts/" + user + "@" + org + ".com-cert.pem"
...
function readPrivateKeyCryptogen(org, user) {
    ...
    var pkFolder = CRYPTO_CONFIG_PEER_ORGS + "/users/" + user + "@" + org + ".com/msp/keystore"
